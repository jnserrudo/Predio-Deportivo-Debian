       ...
       <!-- <div class="imgedit">
        ...
        <div class="cont_orden_pago">
            ...
            <div class="contform_orden_pago">
                ...
                <form class="form_orden_pago"action="abmorden_pago.php" method="POST" id="form">
                    <div class="contformitems_ordenpago">
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            require('queryedicion_ordenpago.php');
                                                                            ?>
                    ...
                    <!-- este no se deberia editar -->
                        ...
                        <input type="text" id="id" class="input_ordenpago" name="id"  readonly value=<?php  echo $resultados[0]; ?>>
                                
                        <label for="nom" class="label">Fecha:</label>
                        
                        <input type="date" id="nom" class="input_ordenpago" name="nom" value=<?php  echo $resultados[1]; ?>>
                        <label for="desc" class="label">Descripcion:</label>
                        
                        <input type="text" id="desc" class="input_ordenpago" name="desc" value=<?php  echo $resultados[2]; ?>>
                        <!--<label for="desc" class="label">Descripcion:</label>
              ...
              <!--  <div class="contbtneliminar">  -->
                         <button class="btn_editar_orden_pago" id="btnrip" >Eliminar Orden</button>
                   <!-- </div>  
...
<footer class="w-100 footer d-flex  align-items-center justify-content-start flex-wrap">
    ...
    <script src="../js/editi_orden_pago.js?v=<?php echo(rand()); ?>"></script>
