...
<header class="header">
    ...
    <div class="main">
        ...
        <div class="cont">
            ...
            <div class="contform">
                <form action="abminstalacion.php" method="POST" id="form">
                    <div class="contformitems">
                                                                        ...
                                                                        <?php 
                                                                            $conexion = NULL;
                                                                                    try{
                                                                                        ...
                                                                                        if (isset($_GET['t'])) {
                                                                                            ...
                                                                                            $sql = "SELECT * FROM instalacion where Id=$z";
                                                                            ...
                                                                            require('queryedicioninstalacion.php');
                                                                            ?>
                    ...
                    <!-- este no se deberia editar -->
                        ...
                        <textarea id="Tipo" cols="15" rows="3" name="Tipo" ><?php  echo $resultados[2]; ?></textarea>
                ...
                <div class="contbtneliminar">
                         <button class="btn" id="btnrip" >Eliminar Instalacion</button>
                    </div>  
...
<footer class="w-100 footer d-flex  align-items-center justify-content-start flex-wrap">
    ...
    <script src="../js/editinstalacion.js?v=<?php echo(rand()); ?>"></script>
