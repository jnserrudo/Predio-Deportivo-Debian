...
//Paginador
            ...
            if (isset($_GET['x'])) {
                ...
                $sql = "SELECT * FROM reservaf5 where Id like '%$c%' or Fecha like '%$c%' or Hora like '%$c%' or Solicitante like '%$c%' or Contacto like '%$c%' or Instalacion like '%$c%' or Disciplina like '%$c%' 
