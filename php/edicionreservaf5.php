...
<header class="header">
    ...
    <div class="main">
        ...
        <div class="cont">
            ...
            <div class="contform">
                <form action="abmreservaf5.php" method="POST" id="form">
                    <div class="contformitems">
                                                                        ...
                                                                        <?php 
                                                                            $conexion = NULL;
                                                                                    try{
                                                                                        ...
                                                                                        if (isset($_GET['t'])) {
                                                                                            ...
                                                                                            $sql = "SELECT * FROM reservaf5 where Id=$z";
                                                                            ...
                                                                            require('queryedicionreservaf5.php');
                                                                            ?>
                    ...
                    <!-- este no se deberia editar -->
                        ...
                        <input type="text" id="Hora" class="input" name="Hora" value=<?php  echo $resultados[2]; ?>>

                        <label for="Solicitante" class="label">Solicitante:</label>
                        <input type="text" id="Solicitante" class="input" name="Solicitante" value=<?php  echo $resultados[3]; ?>>
                        
                        <label for="Contacto" class="label">Contacto:</label>  
                        <input type="text" id="Contacto" class="input" name="Contacto" value=<?php  echo $resultados[4]; ?>>

                        <label for="Disciplina" class="label">Disciplina:</label>
                        <textarea id="Disciplina" cols="15" rows="3" name="Disciplina" ><?php  echo $resultados[5]; ?></textarea>
                ...
                <div class="contbtneliminar">
                         <button class="btn" id="btnrip" >Anular Reserva</button>
                    </div>  
...
<footer class="w-100 footer d-flex  align-items-center justify-content-start flex-wrap">
    ...
    <script src="../js/editreservaf5.js?v=<?php echo(rand()); ?>"></script>
