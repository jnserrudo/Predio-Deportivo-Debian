...
<header class="header">
    ...
    <div class="main">
        ...
        <div class="cont">
            ...
            <div class="contform">
                <form action="abmdisciplina.php" method="POST" id="form">
                    <div class="contformitems">
                                                                        ...
                                                                        <?php 
                                                                            $conexion = NULL;
                                                                                    try{
                                                                                        ...
                                                                                        if (isset($_GET['t'])) {
                                                                                            ...
                                                                                            $sql = "SELECT * FROM disciplina where Id=$z";
                                                                            ...
                                                                            require('queryediciondisciplina.php');
                                                                            ?>
                ...
                <div class="contbtneliminar">
                         <button class="btn" id="btnrip" >Eliminar Disciplina</button>
                    </div>  
...
<footer class="w-100 footer d-flex  align-items-center justify-content-start flex-wrap">
    ...
    <script src="../js/editdisciplina.js?v=<?php echo(rand()); ?>"></script>
