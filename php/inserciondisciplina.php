...
//Paginador
			$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM disciplina");
            ...
            if (isset($_GET['x'])) {
                ...
                $sql = "SELECT * FROM disciplina where Id like '%$c%' or Nombre like '%$c%' or Tipo like '%$c%' 
                LIMIT $desde,$por_pagina ";

            }
            else{
               
                    $sql = "SELECT * FROM disciplina LIMIT $desde,$por_pagina";
