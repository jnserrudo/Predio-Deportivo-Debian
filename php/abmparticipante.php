    ...
    <div class="reg" id="reg">
                        <div class="cont_vent" id="cont_vent">
                            <img src="../assets/cruz.svg" alt="" class="icono_cerrar" id="icono_cerrar">
                                <p class="txt_registrar" >Registrar Participante</p>
...
<!--mainmain-->
          <div class="mainmain">
          <p class="textordencompra"> ADMINISTRACION DE PARTICIPANTES </p>
  <script> if (window.history.replaceState) { // verificamos disponibilidad
                                                                          ...
                                                                          if (empty($_POST["txt_nom"])) {
                                                                              ...
                                                                              if(strlen($_POST['txt_nom'])>=1 && strlen($_POST['txt_Apellido'])>=1 && strlen($_POST['txt_DNI'])>=1 && strlen($_POST['txt_Estado'])>=1 && strlen($_POST['txt_Email'])>=1 && strlen($_POST['txt_Direccion'])>=1 && strlen($_POST['txt_Telefono'])>=1){
                                                                               ...
                                                                               $txt_Telefono=$_POST['txt_Telefono'];
                                                                                  ...
                                                                                  $comprobardato = mysqli_query($conexion,"select * from participante where Nombre = '$txt_nom' ");
                                                                                  if(mysqli_num_rows($comprobardato)>0)
                                                                                      {
                                                                                       ...
                                                                                       $sql="INSERT INTO participante(Nombre,Apellido,DNI,Estado,Email,Direccion,Telefono)Values('$txt_nom','$txt_Apellido','$txt_DNI','$txt_Estado','$txt_Email','$txt_Direccion','$txt_Telefono')";
                                                            ...
                                                            <div class="datatable-container">
                                                                ...
                                                                <div class="header-tools">
                                                                        ...
                                                                        <div class="contbtnreg">
                                                                                              <button class="btnvent button" id="btnvent">Registrar Nuevo Participante</button>   
                                                                                              </div>
                                                                        <div class="buscador">
    ...
    <script src="../js/mainparticipante.js?v=<?php echo(rand()); ?>"></script>
    <script src="../js/prueba.js?v=<?php echo(rand()); ?>"></script>
    <script src="../js/inicio.js?v=<?php echo(rand()); ?>"></script>
    <script src="../js/paginaciones/participante.js?v=<?php  echo(rand()); ?>"></script>
