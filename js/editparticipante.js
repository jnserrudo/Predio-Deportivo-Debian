...
const btnrip=document.getElementById('btnrip')
 ...
 btnconf.addEventListener('click',()=>{
   ...
   var opcion = confirm("Esta seguro de editar el participante?");
  if (opcion == true) {
...
btnrip.addEventListener('click',()=>{
    var opcion = confirm("Esta seguro de eliminar el participante?");
    var r=document.getElementById('prueba').textContent
    if (opcion == true) {
        mensaje = "Has clickado OK";
        window.location.href="../php/abmparticipante.php?r="+r
	} 
})
