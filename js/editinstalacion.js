...
btnconf.addEventListener('click',()=>{
    ...
    var opcion = confirm("Esta seguro de editar la Instalacion?");
    if (opcion == true) {
...
btnrip.addEventListener('click',()=>{
    var opcion = confirm("Esta seguro de eliminar la Instalacion?");
    var r=document.getElementById('Id').value
    console.log(r)
    if (opcion == true) {
        mensaje = "Has clickado OK";
        window.location.href="../php/abminstalacion.php?r="+r
	} 
})
